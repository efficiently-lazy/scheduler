...
for index in model.O:
    vtoprint = pyo.value(model.O[index])
    if vtoprint != 0:
        print("Parameter ",model.O)
        print ("   ",index, vtoprint)  

for index in model.B:
    vtoprint = pyo.value(model.B[index])
    if vtoprint != 0:
        print("Parameter ",model.B)
        print ("   ",index, vtoprint)  